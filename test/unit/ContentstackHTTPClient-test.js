...
import Region from '../../lib/core/region.js'
...
describe('Contentstack HTTP Client', () => {
  ...
  it('Contentstack Http Client Object successful', done => {
    ...
    expect(axiosInstance.defaults.baseURL).to.be.equal('https://defaulthost:443', 'Api not Equal to \'https://defaulthost:443/v3\'')
    done()
  })
  ...
  it('Contentstack Http Client Host', done => {
    ...
    expect(axiosInstance.defaults.headers.apiKey).to.be.equal('apiKey', 'Api not Equal to \'apiKey\'')
    expect(axiosInstance.defaults.headers.accessToken).to.be.equal('accessToken', 'Api not Equal to \'accessToken\'')
    expect(axiosInstance.defaults.baseURL).to.be.equal('https://contentstack.com:443', 'Api not Equal to \'https://defaulthost:443/v3\'')
    done()
  })
  ...
  it('Contentstack Http Client Host without port', done => {
    ...
    expect(axiosInstance.defaults.headers.apiKey).to.be.equal('apiKey', 'Api not Equal to \'apiKey\'')
    expect(axiosInstance.defaults.headers.accessToken).to.be.equal('accessToken', 'Api not Equal to \'accessToken\'')
    expect(axiosInstance.defaults.baseURL).to.be.equal('https://contentstack.com:443', 'Api not Equal to \'https://contentstack.com:443/v3\'')
    done()
  })
  ...
  it('Contentstack Http Client Host with basePath', done => {
    ...
    expect(axiosInstance.defaults.headers.apiKey).to.be.equal('apiKey', 'Api not Equal to \'apiKey\'')
    expect(axiosInstance.defaults.headers.accessToken).to.be.equal('accessToken', 'Api not Equal to \'accessToken\'')
    expect(axiosInstance.defaults.baseURL).to.be.equal('https://contentstack.com:443/stack', 'Api not Equal to \'https://contentstack.com:443/stack/v3\'')
    done()
  })
